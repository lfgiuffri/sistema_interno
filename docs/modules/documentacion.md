...
- **Las imágenes no son adjuntos**: van al cuerpo. El detalle filtra `tipo: 'archivo'` para no duplicar en la lista lo que ya se ve embebido, así que subir una imagen con el botón «Adjuntar» avisa que se inserte desde el editor en vez de simular que se adjuntó.
